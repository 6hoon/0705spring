...
<body>
	...
	<form action="/registerUserCardList" method="post">
		...
		유효년월 : <input type="text" name="cardList[0].validMonth" /><br> <br>
		카드2 - 번호 : <input type="text" name="cardList[1].no" /><br> 카드2 -
		유효년월 : <input type="text" name="cardList[1].validMonth" /><br> <br>
